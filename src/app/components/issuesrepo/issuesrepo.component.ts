...
@Component({
  selector: 'app-issuesrepo',
  templateUrl: './issuesrepo.component.html',
  styleUrls: ['./issuesrepo.component.css']
})
export class IssuesrepoComponent implements OnInit, AfterViewInit {
