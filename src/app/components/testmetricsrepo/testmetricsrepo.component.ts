...
@Component({
  selector: 'app-testmetricsrepo',
  templateUrl: './testmetricsrepo.component.html',
  styleUrls: ['./testmetricsrepo.component.css']
})
export class TestmetricsrepoComponent implements OnInit, AfterViewInit {
